...
const links = {
  product: [
    ...
    { label: "Documentation", href: "https://github.com/untraced/docs" },
  ],
  resources: [
    { label: "GitHub", href: "https://github.com/untraced" },
    { label: "SDK", href: "https://github.com/untraced/sdk" },
    { label: "Contracts", href: "https://github.com/untraced/contracts" },
  ],
  company: [
    { label: "About", href: "#" },
    { label: "Blog", href: "#" },
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <Image
                ...
                className="w-8 h-8"
              />
              <span className="text-lg font-medium text-foreground">UNTRACED</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              Zero-Knowledge Verification Protocol. Prove facts without revealing identity.
            </p>
